...
<body>
    ...
    <script id="2d-fragment-shader" type="x-shader/x-fragment">// <![CDATA[
      ...
      float snoise(vec3 v)
        ...
        void main() {
          vec3 color1 = vec3(1.0/255.0,0.0/255.0,111.0/255.0);
          vec3 color2 = vec3(1.0/255.0,0.0/255.0,111.0/255.0);
          vec3 color3 = vec3(1.0/255.0,0.0/255.0,111.0/255.0);
          vec3 color4 = vec3(1.0/255.0,0.0/255.0,111.0/255.0);
          vec3 color5 = vec3(1.0/255.0,0.0/255.0,111.0/255.0);
          vec3 color6 = vec3(1.0/255.0,0.0/255.0,111.0/255.0);
